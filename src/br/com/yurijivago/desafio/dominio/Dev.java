...
public class Dev {
    ...
    public void inscreverBootcamp(Bootcamp bootcamp){
        System.out.println("Parabéns! Sua inscrição no bootcamp será um passo importante para a sua evolução na carreira de desenvolvedor");
    ...
    public void progredir(){
        ...
        if(conteudo.isPresent()){
            System.out.println("Parabéns! Você está progredindo!\n" +
                    "Acaba de concluir " + conteudo.get().toString());
